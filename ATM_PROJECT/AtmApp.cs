namespace ATM_PROJECT
{
    public partial class Atm_App : Form
    {
        ...
        void GroupboxCLEAR(GroupBox groupBox)
        {
            ...
            {
                if (txt is TextBox)  //textboxlar˝ silicek
                {
        ...
        private void btnSign›n_Click(object sender, EventArgs e)
        {
            bool resault1 = false;
            bool resault2 = false;
            ...
            {
                if (userId == textSign›nUserID.Text)
                {
                    resault1 = true;
                    foreach (string password in users.Values)
                    {
                        if (password == textSign›nPassword.Text)
                        {
                            resault2 = true;
                        }
